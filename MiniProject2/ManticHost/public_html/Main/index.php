	<?php
                    ...
                    //     session_unset();
                    // }
                    // $_SESSION['LAST_ACTIVITY'] = time(); //end
                    //#######################################
                    ////////////////////////////////////
                    if(isset($_SESSION["validate_session"]) && !empty($_SESSION["validate_session"])) {
                        echo "good to go";
                    }
                    else{
                        print '<script type="text/javascript">alert("Session Time Out\nLogin Again!!");location.href = "../../Login/index.html";</script>';
                    }
	?>
	<!DOCTYPE html>
	...
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			/*Loader css*/
			    #load{
                    ...
                    position:fixed;
                    z-index:9999;
                    background:url("css/loader.gif") no-repeat center center rgba(0,0,0,0.25)
                }
                #:0.targetLanguage {
                    z-index: 9;
                }
        ...
        function googleTranslateElementInit() {
			...
			<script src="js/passEmail.js"></script>
			<script>
			    //loader starts
                ...
                function clearText(){
                    var query = document.getElementById("af").value;
                    window.open('mailto:vectorparker0047@gmail.com?subject=Query&body='+query);
...
<!--chat start-->
        ...
        <div class="chat-popup" id="myForm">
          <form action="/action_page.php" class="form-container">
            ...
            <textarea id="af" placeholder="Type message..." name="msg"></textarea>
            <button type="submit" class="btn" onclick="clearText()">Send</button>
			  ...
			  <header id="header" id="home">
		  			...
		  			<div class="container">
				  		<div class="row">
				  			...
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
				  				...
				  				<a id="email" href="mailto:vectorparker0047@gmail.com"><?php echo $_SESSION["validate_session"] ?></a>
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.php"><img src="" alt="" title="Smart Health" /></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="medicine.html">Medication</a></li>
				          <li class="menu-has-children"><a href="fitness.html">Fitness Tips</a>
				            <ul>
				              <li><a href="fitness.html">Fitness Videos</a></li>
				              <li><a href="fitness.html">Fitness Program</a></li>
				            </ul>
				          </li>						          
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center">
						<div class="banner-content col-lg-7 col-md-6 justify-content-center ">
							<h6 class="text-uppercase">Welcome to smart Health</h6>
							<h1>
								Live Healthy			
							</h1>
							<p class="text-white">
								We at smart health provide best services to keep you healthy. If you want to stay fit, healthy or you have any doubt regarding your health then use oir different services...
							</p>
							<a href="services.html" class="primary-btn header-btn text-uppercase mt-10">Get Started</a>
						</div>	
